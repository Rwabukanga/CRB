...
import com.CRBProjectt.CRBProjectt.domain.AuthenticationResponse;
...
public class createAuthenticationToken {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody SystemUser authenticationRequest) throws Exception {
